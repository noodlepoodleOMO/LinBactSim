...
public class ForceModel4RayCutoff implements MovementModel {
    ...
    public double computeDirection(Bacterium bacterium, Maze maze, double noiseBound) {
        ...
        double fUp    = force(bacterium, d[0]);
        double fDown  = force(bacterium, d[1]);
        double fRight = force(bacterium, d[2]);
        double fLeft  = force(bacterium, d[3]);
        ...
        bacterium.setLastVectorInfo("Force4Cut", d,
